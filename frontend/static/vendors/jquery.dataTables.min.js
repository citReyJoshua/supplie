...
$jscomp.polyfill = function (f, y, w, n) {
  if (y) {
    ...
    y != n &&
      null != y &&
      $jscomp.defineProperty(w, f, { configurable: !0, writable: !0, value: y });
  }
};
$jscomp.polyfill(
...
(function (f) {
      ...
      if (0 !== l.length)
        for (h = k ? a.aoData.length : m, k = k ? 0 : g; k < h; k++) {
          ...
          if (0 !== e) {
            var q = d[c % e];
            v._sRowStripe != q &&
              (f(u).removeClass(v._sRowStripe).addClass(q), (v._sRowStripe = q));
          }
  ...
  function tb(a) {
    ...
    b = f("<div/>", { id: h.f ? null : c + "_filter", class: b.sFilter }).append(
      f("<label/>").append(k)
    );
    var l = function () {
  ...
  var q = function (a) {
      ...
      this.fnAddData = function (a, b) {
        var c = this.api(!0);
        a =
          f.isArray(a) && (f.isArray(a[0]) || f.isPlainObject(a[0])) ? c.rows.add(a) : c.row.add(a);
        (b === n || b) && c.draw();
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          g.bStateSave
            ? ((C.bStateSave = !0), D(r, "aoDrawCallback", Aa, "state_save"), Nb(r, g, e))
            : e();
        }
      });
      b = null;
    ...
    if (f.isArray(a)) for (var c = 0, d = a.length; c < d; c++) x.register(a[c], b);
      ...
      for (c = d.length; a < c; a++) {
        ...
        a === c - 1
          ? ((k.val = b),
            (k.type =
              "function" === typeof b ? "function" : f.isPlainObject(b) ? "object" : "other"))
  ...
  t("draw()", function (a) {
    return this.iterator("table", function (b) {
      "page" === a
        ? S(b)
        : ("string" === typeof a && (a = "full-hold" === a ? !1 : !0), U(b, !1 === a));
    });
  });
  t("page()", function (a) {
    return a === n
  ...
  var gc = function (a, b, c, d) {
    ...
    Yb = function (a, b) {
      ...
      c.length &&
        ...
        ((a = c[0].aoData[a[0]]),
        a._details &&
          ((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(), hc(c[0])));
    },
    hc = function (a) {
      var b = new x(a),
        c = a.aoData;
        ...
        f(a.nTable).on("order.dt.DT", function (e, f, g, k) {
          a === f &&
            ...
            b
              ...
              .addClass(
                "asc" == k[e] ? d.sSortAsc : "desc" == k[e] ? d.sSortDesc : c.sSortingClass
              ));
        });
      },
